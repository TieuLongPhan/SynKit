...
#         self.G_swapped.add_node('a', element='C', charge=0)
#         self.G_swapped.add_node('b', element='O', charge=0)
#         self.G_swapped.add_edge('a', 'b', order=1)
...
#         sig1 = self.canon.canonical_signature(self.G)
#         sig2 = self.canon.canonical_signature(self.G_swapped)
#         self.assertEqual(sig1, sig2, "Graphs with same structure should have equal signatures")
...
#         self.assertNotEqual(sigG, sigH, "Different graphs should have different signatures")

#     # def test_make_canonical_graph_structure(self):
#     #     G_can = self.canon.make_canonical_graph(self.G)
...
#     #     self.assertEqual(cgraph.canonical_smiles, self.canon.canonical_signature(self.G))
