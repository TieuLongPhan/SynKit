...
class FrameworkStereo(GlobalStereo):
    ...
    def __post_init__(self) -> None:
        ...
        if any(not frame.dependencies.issubset(self.support_atoms) for frame in self.frames):
            raise ValueError(
    ...
    def canonical_form(self) -> tuple[Any, ...]:
        ...
        for frame in self.frames:
            ...
            configured_relation = (
                None
                if self.orientation is None
                else relation * self.orientation
            )
    ...
    def __post_init__(self) -> None:
        ...
        if self.state is GlobalStereoInformationState.POTENTIAL:
            ...
            if (
                ...
                and self.descriptor.orientation is not None
            ):
                raise ValueError(
