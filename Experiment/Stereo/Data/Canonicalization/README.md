...
## 1. Exhaustive local-reference permutations
...
classes, rechecks all 940 raw local arrangements, performs 134 per-class
...
## 3. Public whole-graph relabeling
