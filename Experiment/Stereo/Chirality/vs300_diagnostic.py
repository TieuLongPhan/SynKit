...
def build_minimal_fixtures() -> dict[str, Any]:
    ...
    for fixture in MINIMAL_FIXTURES:
        ...
        if complete.classification.value != fixture["expected_topology_complete"]:
            raise ValueError(f"Unexpected topology result for {fixture['fixture_id']}.")
        ...
        evaluated.append(
            {
                **fixture,
                ...
                "observed": {
                    ...
                    "without_topology_completion": (incomplete.classification.value),
                    "with_topology_completion": complete.classification.value,
                    "completed_centers": list(complete.completed_tetrahedral_centers),
                },
            }
        )
    ...
    left_graph, left_registry = _rdkit_graph_and_registry(restored_molecules[left_id])
