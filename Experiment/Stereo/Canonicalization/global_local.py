#!/usr/bin/env python3
"""Audit selective whole-graph relabelings across every local stereo class.

Local configurations are covered exhaustively. The global relabeling product
is exhaustive for explicitly small fixtures and deterministic/sample-bounded
for larger fixtures, avoiding an uninformative factorial Cartesian explosion.
"""
...
def benchmark_global_local_canonicalization(
    path: Path,
    *,
